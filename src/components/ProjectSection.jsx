        ...
        <section id="projects" className="py-24 px-4 relative">
            <div className="container mx-auto max-w-5xl">
                ...
                <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                    Here are some of my projects — each built with care, attention to detail,
                    and performance in mind. And yes, more are on the way!
                </p>
                ...
                <div className="text-center mt-12">
                    <a
                        className="stellar-button w-fit flex items-center mx-auto gap-2"
                        target="_blank"
                        href="https://github.com/Shresth-013"
                    >
